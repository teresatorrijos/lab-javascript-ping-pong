...
Board.prototype.checkBallCollision = function(){
    if (this.userPaddle.hitBall(this.ball.x - 10, this.ball.y + 10) || this.compPaddle.hitBall(this.ball.x + 20, this.ball.y + 10)) {
        this.ball.directionX *= -1;
        this.ball.x += 10 * this.ball.directionX;
...
Board.prototype.locateBallAtCenter = function(){
    ...
    this.ball.x = (this.sizeX / 2) - 10;
    this.ball.y = (this.sizeY / 2) - 10;
};
